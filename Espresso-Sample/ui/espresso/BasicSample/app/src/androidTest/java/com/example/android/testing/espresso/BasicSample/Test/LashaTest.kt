...
class LashaTest {
    ...
    fun lashaTest() {
        ...
        editText2.perform(replaceText("lasha khumarashvili"), closeSoftKeyboard())
        ...
        val textView = onView(
            allOf(
                withId(R.id.show_text_view), withText("lasha khumarashvili"),
                withParent(
                    allOf(
                        withId(android.R.id.content),
        ...
        textView.check(matches(withText("lasha khumarashvili")))
    }
